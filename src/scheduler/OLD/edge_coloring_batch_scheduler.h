...
// This file contains a few batch schedulers based on some edge coloring algorithms.
//
// More precisely, it contains:
//        RandomizedEdgeColoringCAggarwal - Simple randomized edge coloring based scheduler
//
