...
// Note this class is simply a wrapper for lemon::MaxWeightedMatching<Graph,
// WeightMap>. If you are interested in which implementation of Maximum Weight
// Matching algorithm is used, please refer to <a
// HREF="http://lemon.cs.elte.hu/pub/doc/1.2.3/a00219.html">
